      ...
      @auth
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="login">
            ...
            <li><a class="dropdown-item" href="{{ route('restos.login') }}">Restaurant</a></li>
            <li><a class="dropdown-item" href="{{ route('livreur.login') }}">Livreur</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          @if (Route::has('register'))
            ...
            <li><a class="dropdown-item" href="{{ route('autre') }}">Assistant_Restaurant</a></li>
